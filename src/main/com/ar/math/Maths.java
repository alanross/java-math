...
public final class Maths
{
	 ...
	 */
	public static boolean equals2D( Point2D a, Point2D b, double precision )
	{
		double dx = b.x - a.x;
		double dy = b.y - a.y;
	 ...
	 *      2
	 */
	public static int getDirection2D( Point2D center, Point2D relative )
	{
		//right side
	 ...
	 *
	 */
	public static LinkedList<Point2D> grid( int rows, int cols, int spacingX, int spacingY, int offsetX, int offsetY )
	{
		...
		for( int r = 0; r < rows; ++r )
		{
			...
			{
				points.addLast( new Point2D( ( c * spacingX ) + offsetX, ( r * spacingY ) + offsetY ) );
			}
		}
	 ...
	 *
	 */
	public static LinkedList<Point2D> grid2( int width, int height, int spacingX, int spacingY, int offsetX, int offsetY )
	{
	 ...
	 *
	 */
	public static void quantize2D( Point2D pos, double hq, double vq )
	{
	 ...
	 */
	public static void rotateBy( double deg, int radius, Point2D point )
	{
