...
{
	public final Point2D bl = new Point2D();
	public final Point2D tl = new Point2D();
	public final Point2D tr = new Point2D();
	public final Point2D br = new Point2D();
	 ...
	 */
	public RectComplex( double x, double y, double width, double height )
	{
	 ...
	 */
	public void rotateBy( double radian, Point2D pivot )
	{
		double dx = 0.0;
		double dy = 0.0;
	 ...
	 */
	public void transformAll( Point2D offset, Point2D scale, double radian, Point2D pivot )
	{
	 ...
	 */
	public boolean containsPoint2D( Point2D p )
	{
	...
	public Rect getBounds()
	{
		...
		_bounds.setX( xMin );
		_bounds.setY( yMin );
		_bounds.setWidth( xMax - xMin );
		_bounds.setHeight( yMax - yMin );
