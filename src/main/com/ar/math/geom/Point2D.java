...
public final class Point2D
{
	 ...
	 */
	public void subPoint( Point2D point )
	{
		this.x -= point.x;
		this.y -= point.y;
	}
	 ...
	 */
	public void multPoint( Point2D point )
	{
		this.x *= point.x;
		this.y *= point.y;
	}
	 ...
	 */
	public void divPoint( Point2D point )
	{
		this.x /= point.x;
		this.y /= point.y;
	}
	 ...
	 */
	public double dotPoint( Point2D point )
	{
	 ...
	 */
	public double distPoint( Point2D point )
	{
